                ...
                <section className={`${styles.section} ${styles.welcome}`}>
                    <div className={styles.body}>
                        <div className={styles.logo}>
                            <img src="images/variance-solutions-logo.svg" alt="Variance Solutions logo" />
                        </div>
                    </div>
                    <div className={styles.title}>
                        <h1>Lead front-end developer, accessibility auditor & certified scrum master</h1>
                    </div>
                </section>
                <section className={styles.section}>
                    <div className={styles.body}>
                        <h2 id="personal-note">Personal note</h2>
                        <p>My name is Tim Hilhorst, and welcome to my Variance Solutions company page.</p>
